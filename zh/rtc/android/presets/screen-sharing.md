---
title: "屏幕共享预设"
description: "Android SRTC 音视频 SDK 屏幕共享预设 PreOptionScreen"
---

本页说明屏幕共享预设 `PreOptionScreen`。预设通用结构（采集配置 + 推送配置）见 [摄像头预设](/zh/rtc/android/presets/camera)。
...
作用说明：同视频发布参数结构（字段见 [摄像头预设](/zh/rtc/android/presets/camera)），默认 `desc` 为 `TRACK_SHARE`。
